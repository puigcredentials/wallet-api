...
import es.puig.wallet.domain.exception.InvalidPinException;
...
import es.puig.wallet.domain.service.PreAuthorizedService;
import es.puig.wallet.infrastructure.core.config.PinRequestWebSocketHandler;
import es.puig.wallet.infrastructure.core.config.WebClientConfig;
import es.puig.wallet.infrastructure.core.config.WebSocketSessionManager;
...
public class PreAuthorizedServiceImpl implements PreAuthorizedService {
    ...
    private Mono<String> getAccessToken(String tokenURL, CredentialOffer credentialOffer, String pin) {
        ...
        formDataMap.put("grant_type", ApplicationConstants.PRE_AUTH_CODE_GRANT_TYPE);
