...
import static es.puig.wallet.domain.util.MessageUtils.ERROR_UPDATING_RESOURCE_MESSAGE;
import static es.puig.wallet.domain.util.MessageUtils.RESOURCE_UPDATED_MESSAGE;
